    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            ...
            >
                ...
                <button className="relative flex items-center justify-center p-1 transition-all duration-300 hover:bg-dark hover:shadow-lg hover:shadow-green-500 rounded-lg" onClick={changeState}>
            ...
            <div
                className="absolute left-0 top-0 z-30 w-full flex-grow flex-col bg-dark md:static md:w-[300px]"
